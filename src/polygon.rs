...
pub fn fill_polygon(framebuffer: &mut Framebuffer, points: &[Vector2]) {
    ...
    for y in y_min..=y_max {
        ...
        for i in 0..n {
            ...
            // The scanline crosses this edge only if y is inside its vertical range.
            // Using a half-open range avoids counting shared vertices twice.
        ...
        // Fill the spans between each pair of intersections.
